...
* The notable exceptions to obvious mappings were 1) faculty currently in IPHYS with a metabolism / endocrinology focus; I put them in HGCB. And 2) 10-15 clinical researchers without a clear home; for example, Peter Buttrick is in the list, which program would he gravitate to? HGCB?

* The sizes of unique associations are fairly consistent, with four of the new programs having 70-80 faculty. The outlier is CAN (Cancer Biology and Pharmacology) with 51 total faculty (42 plus the overlaps).
